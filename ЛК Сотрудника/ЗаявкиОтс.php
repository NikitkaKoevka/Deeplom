...
<body>
    ...
    <div class="container">
        ...
        <div class="Applications" >
            <div id='contextMenu'>
                    <div id='deleteMessage' class='delete' onclick="deleteMessage()">
            ...
            <div class="Vagner"id="requests">
                ...
                if($sortirovka != NULL)
                {
                    $query = "SELECT * FROM request WHERE  Request_owner = $sortirovka AND Request_response = $idd  ORDER BY CreationDate DESC";
                    $result = $conn->query($query);
